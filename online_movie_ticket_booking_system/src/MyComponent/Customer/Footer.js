          ...
          <div className="container py-4">
            <div className="row" style={{ justifyContent: "center", marginLeft: "8pc" }}>
              <div className="col-lg-6">
                <div><img src='/movie_logo_13.png' alt="movie-logo" width={width >= 1024 ? "400px" : "150px"} height="150px"></img></div>
                <p className="fst-italic text-white" style={width >= 1024 ? { marginLeft: "7pc" } : {}}> Thank you for visiting ...</p>
              </div>
            </div>
          </div>
        </section>
